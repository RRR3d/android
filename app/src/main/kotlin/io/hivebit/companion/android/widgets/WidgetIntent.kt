 ...
 */
const val ACTION_APPWIDGET_CREATED = "io.hivebit.companion.android.widgets.APPWIDGET_CREATED"

/**
 * Should be a subtype of [io.hivebit.companion.android.database.widget.WidgetEntity] to inject in the DAO with the
