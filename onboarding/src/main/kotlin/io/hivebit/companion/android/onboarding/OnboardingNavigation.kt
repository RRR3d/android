...
import io.hivebit.companion.android.compose.locationPermissions
...
import io.hivebit.companion.android.onboarding.connection.navigation.connectionScreen
import io.hivebit.companion.android.onboarding.connection.navigation.navigateToConnection
import io.hivebit.companion.android.onboarding.localfirst.navigation.LocalFirstRoute
import io.hivebit.companion.android.onboarding.localfirst.navigation.localFirstScreen
...
import io.hivebit.companion.android.onboarding.locationforsecureconnection.navigation.locationForSecureConnectionScreen
...
import io.hivebit.companion.android.onboarding.locationsharing.navigation.locationSharingScreen
import io.hivebit.companion.android.onboarding.locationsharing.navigation.navigateToLocationSharing
import io.hivebit.companion.android.onboarding.manualserver.navigation.manualServerScreen
import io.hivebit.companion.android.onboarding.manualserver.navigation.navigateToManualServer
import io.hivebit.companion.android.onboarding.nameyourdevice.navigation.nameYourDeviceScreen
import io.hivebit.companion.android.onboarding.nameyourdevice.navigation.navigateToNameYourDevice
import io.hivebit.companion.android.onboarding.nameyourweardevice.navigation.nameYourWearDeviceScreen
...
import io.hivebit.companion.android.onboarding.serverdiscovery.navigation.serverDiscoveryScreen
import io.hivebit.companion.android.onboarding.sethomenetwork.navigation.navigateToSetHomeNetworkRoute
import io.hivebit.companion.android.onboarding.sethomenetwork.navigation.setHomeNetworkScreen
import io.hivebit.companion.android.onboarding.wearmtls.navigation.navigateToWearMTLS
import io.hivebit.companion.android.onboarding.wearmtls.navigation.wearMTLSScreen
import io.hivebit.companion.android.onboarding.welcome.navigation.WelcomeRoute
import io.hivebit.companion.android.onboarding.welcome.navigation.welcomeScreen
import io.hivebit.companion.android.util.canGoBack
